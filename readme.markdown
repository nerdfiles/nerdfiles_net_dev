# [nerdfiles.net](http://nerdfiles.net) [dash](http://nerdfiles.net/dashboard/) [github](http://github.com/nerdfiles/nerdfiles_net_dev) : [ssh](git://git+git@github.com:nerdfiles/nerdfiles_net_dev.git#nerdfiles_net_dev)
