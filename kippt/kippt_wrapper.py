...
class user:
    ...
    def __init__(self, username, apitoken):
        ...
        self.header = {
            'X-Kippt-Username': username, 'X-Kippt-API-Token': apitoken,
            'X-Kippt-Client':
            'Kippt-Python-Wrapper,me@ThomasBiddle.com,https://github.com/thomasbiddle/Kippt-Projects',
    ...
    def getLists(self, limit=0, offset=0):
        url = 'https://kippt.com/api/lists?limit=' + \
    ...
    def getClips(self, listID=None, limit=0, offset=0):
        url = 'https://kippt.com/api/clips?limit=' + \
            str(limit) + '&offset=' + str(offset)
    ...
    def search(self, query, limit=0, offset=0):
        ...
        r = requests.get(
            'https://kippt.com/api/search/clips/?q=' +
            query +
            '&limit=' +
            str(limit) +
            '&offset=' +
